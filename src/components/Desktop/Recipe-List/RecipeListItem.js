...
const RecipeListItem = ({ rec, setHero }) => {
    return (
        <div
            onClick={() => setHero(rec)}
        ...
        >
            <div className="w-[30%] flex justify-center items-center ">
                <img className="rounded-full w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18" src={rec.image_url} alt="" />
            </div>
            <div className="w-[70%] h-20 text-center flex flex-col justify-center items-center">
                <div className="h-[3rem] overflow-hidden text-ellipsis">{""}</div>
