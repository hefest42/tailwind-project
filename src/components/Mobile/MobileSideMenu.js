...
const MobileSideMenu = ({ displaySideMenu, recipes, setHeroID, isRecipeListLoading, bookmarks }) => {
    ...
    return (
        <div
            {...handlers}
            className={`md:hidden absolute top-0 left-0 bg-dark-blue w-[75%] xs:w-[55%] h-screen overflow-scroll mt-4 flex flex-col justify-start items-start transition-transform ${
        ...
        >
            ...
            <div className="relative w-full h-full">
                ...
                />
                <BookmarksMobile displayBookmarks={displayBookmarks} bookmarks={bookmarks} />
            </div>
        </div>
    );
};
